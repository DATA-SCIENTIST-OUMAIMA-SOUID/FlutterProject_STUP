...
class User {
  ...
  User(
      ...
      : this.lastOnlineTimestamp = lastOnlineTimestamp ?? Timestamp.now(),
        ...
        this.appIdentifier = 'Flutter  Consumer ${Platform.operatingSystem}',
        this.shippingAddress = shippingAddress ?? AddressModel(),
        this.shippingAddress2 = shippingAddress2 ?? AddressModel(),
  ...
  factory User.fromJson(Map<String, dynamic> parsedJson) {
    return User(
        ...
        shippingAddress: parsedJson.containsKey('shippingAddress')
            ...
            : AddressModel(),
        shippingAddress2: parsedJson.containsKey('shippingAddress2')
            ? AddressModel.fromJson(parsedJson['shippingAddress2'])
            : AddressModel(),
        ...
        inProgressOrderID: parsedJson['inProgressOrderID'] is String
    ? parsedJson['inProgressOrderID']
    : '',
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {
      ...
      'shippingAddress2':this.shippingAddress2.toJson(),
