...
class _PlaceOrderScreenState extends State<PlaceOrderScreen> {
  ...
  animateOut() {
    FireStoreUtils.sendFcmMessage(
        "newOrder".tr,
        '${MyApp.currentUser!.firstName}' + "hasOrdered",
          ...
          child: Column(
            children: [
              ...
              ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 40),
                title: Text(
                  'Your order, ${widget.orderModel.address.name}'.tr,
                  style: TextStyle(
                    color: isDarkMode()
                        ? Colors.grey.shade300
                        : Colors.grey.shade800,
  ...
  @override
  void initState() {
    timer = Timer(Duration(seconds: 1), () => animateOut());
    super.initState();
  }
}
