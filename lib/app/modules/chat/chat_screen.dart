...
import '../../../main.dart';
import '../../data/model/ChatVideoContainer.dart';
              ...
              child: GestureDetector(
                ...
                child: PaginateFirestore(
                  ...
                  itemBuilder: (context, documentSnapshots, index) {
                    ...
                    return chatItemView(
                        inboxModel.senderId == MyApp.currentUser!.userID,
                        inboxModel);
                  },
                  ...
                  data.messageType == "text"
                      ? Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                                color:
                                    data.senderId == MyApp.currentUser!.userID
                                        ? Colors.white
                                        : Colors.black),
                          ),
                        )
  ...
  _sendMessage(String message, Url? url, String videoThumbnail,
    ...
    if (url != null) {
      if (url.mime.contains('image')) {
        conversationModel.message = "sentAnImage".trArgs(
            ['${MyApp.currentUser!.firstName} ${MyApp.currentUser!.lastName}']);
      } else if (url.mime.contains('video')) {
        conversationModel.message = "sentAVideo".trArgs(
            ['${MyApp.currentUser!.firstName} ${MyApp.currentUser!.lastName}']);
      } else if (url.mime.contains('audio')) {
        conversationModel.message = "sentAVoiceMessage".trArgs(
            ['${MyApp.currentUser!.firstName} ${MyApp.currentUser!.lastName}']);
      }
    }
    ...
    FireStoreUtils.sendFcmMessage(widget.customerName.toString(),
